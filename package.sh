...
#Source
jar --no-manifest --create  --file packages/com-thierryleroy-modulejava-helloworld-0.1.0-sources.jar -C sources/com.thierryleroy.modulejava.helloworld .
jar --no-manifest --create --file packages/com-thierryleroy-modulejava-helloworld-french-0.1.0-sources.jar -C sources/com.thierryleroy.modulejava.helloworld.french .
#Classes
